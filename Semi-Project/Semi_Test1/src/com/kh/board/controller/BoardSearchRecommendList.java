...
@WebServlet("/boardsearchreco")
public class BoardSearchRecommendList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public BoardSearchRecommendList() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list = new BoardService().getBoardSearchRecoList(searchword, searchoption,info);		
		...
		request.getRequestDispatcher("/views/board/SearchReco.jsp").forward(request, response);
	}
