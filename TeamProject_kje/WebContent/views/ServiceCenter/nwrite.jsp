...
<div id="QnAcontainer">
    ...
    <label class="title">제목 : <input type="text" name="NTITLE" id="title" placeholder="제목을 입력해주세요."></label> <br>
    <label class="writer">회원번호 : <input type="text"name="User_Num" id="writer"></label> <br>
    <textarea name="NCONTENT" id="content" cols="30" rows="10" placeholder="내용을 입력해주세요." style="resize: none;"></textarea>
